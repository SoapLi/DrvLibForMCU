...
*/
#ifndef WEATHER_HTTPS_SERVICE_H
#define WEATHER_HTTPS_SERVICE_H
...
#define HTTPS_URL_XA            "https://api.seniverse.com/v3/weather/daily.json?key=4nik0ivxfmxfjzz1&location=xian&language=en&unit=c&start=0&days=5"
...
/* GET请求 */
#define USR_HTTPS_GET                      "GET /%s HTTP/1.1\r\nAccept:*/*\r\nHost:%s\r\n\r\n"
/* POST请求,此章节暂时不讲 */
#define USR_HTTPS_POST                    "POST /%s HTTP/1.1\r\nAccept: */*\r\nContent-Length: %d\r\nContent-Type: application/x-www-form-urlencoded; charset=utf-8\r\nHost: %s\r\nConnection: Keep-Alive\r\n\r\n%s"
